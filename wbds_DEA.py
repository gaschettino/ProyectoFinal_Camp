...
import pickle as pkl  # Se parca como unuse porque está comentados los procesos de lectura de archivos pkl.
...
pathlist=['/home/usuario/Documents/ProyectoFinal_Camp', os.getcwd()]
flag=False
for p in pathlist:
...
# =============================================================================
# # OPCIONAL: Se guarda el archivo intermedio con el único fin de poder reanudar el script desde este punto de ser necesario. 
...
# =============================================================================
# OPCIONAL. Guardado de archivos intermedios
...
# =============================================================================
# OPCIONAL. Paso de guardado de archivo intermedio
...
# df_shrink.to_csv(filepath, sep='\t',index=True)
# =============================================================================
